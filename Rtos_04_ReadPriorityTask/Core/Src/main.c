...
int main(void)
{
  ...
  xTaskCreate(vBlueTask,
		  ...
		  NULL,
		  1,
		  &blueHandle); //parametro per la gestione del task
...
void vRedTask(void *pvParameters)
{
	...
	int i=0;
		...
		vTaskPrioritySet(NULL, 3); // in questo caso passando il parametro NULL ci si riferisce allo stesso task
